 ...
 */
class TesterProfileForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['profile_section']['container']['full_name'] = [
      ...
      '#required' => TRUE,
    //   '#default_value' => $existing_profile ? $existing_profile->get('field_full_name')->value : '',
    ...
    //   '#default_value' => $existing_profile ? $existing_profile->get('field_country')->value : '',
    ...
    //   '#default_value' => $existing_profile ? $existing_profile->get('field_portfolio_link')->uri : '',
    ...
    //   '#default_value' => $existing_profile ? $existing_profile->get('field_youtube_link')->uri : '',
    ...
    // ID Verification
    $default_id_files = [];
    // if ($existing_profile && !$existing_profile->get('field_id_verification')->isEmpty()) {
    //   foreach ($existing_profile->get('field_id_verification') as $item) {
    ...
    //   '#default_value' => $existing_profile ? $existing_profile->get('field_previous_jobs')->value : '',
    ...
    //   '#default_value' => $existing_profile ? $existing_profile->get('field_instagram_account')->value : '',
    ...
    //   '#default_value' => $existing_profile ? $existing_profile->get('field_facebook_account')->value : '',
    ...
    //   '#default_value' => $existing_profile ? $existing_profile->get('field_x_account')->value : '',
    ...
    $form['profile_section']['container']['work_type'] = [
      ...
      '#options' => $work,
    //   '#default_value' => $existing_profile ? $existing_profile->get('field_work_type')->value : '',
    ...
    $form['profile_section']['container']['skills'] = [
      ...
      '#type' => 'textfield',
      '#title' => $this->t('Skills'),
    //   '#default_value' => $existing_profile ? $existing_profile->get('field_skills')->value : '',
      '#attributes' => ['class' => ['form-control'], 'placeholder' => 'E.g. QA Testing, Selenium, Automation'],
      '#suffix' => '</div>',
    ];

       $default_languages = [];
    // if ($existing_profile && !$existing_profile->get('field_languages_known')->isEmpty()) {
    //   foreach ($existing_profile->get('field_languages_known') as $item) {
    //     $default_languages[] = $item->value;
    //   }
    // }
    ...
    //   '#default_value' => $existing_profile ? $existing_profile->get('field_other_language')->value : '',
    //   '#attributes' => ['class' => ['form-control', 'mt-2'], 'placeholder' => 'Other language...'],
    '#attributes' => [
    'class' => ['language-known-wrapper', 'js-form-wrapper', 'form-wrapper', 'placeholder' => 'Other language...'],
  ],
      '#suffix' => '</div></div>',
    ];
...
//   $node->set('field_other_language', $form_state->getValue('other_language'));
  ...
  $node->set('field_language', $selected_languages);
  ...
  $this->messenger()->addMessage($this->t('New profile created successfully.'));
}
